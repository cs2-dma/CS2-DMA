...
#undef Qc3_Alg_Token
#define Qc3_Alg_Token       "\xC1\xD3\xC7\xC4\xF0\xF1\xF0\xF0"  
#undef Qc3_Alg_Block_Cipher
#define Qc3_Alg_Block_Cipher "\xC1\xD3\xC7\xC4\xF0\xF2\xF0\xF0" 
#undef Qc3_Alg_Block_CipherAuth
#define Qc3_Alg_Block_CipherAuth                                            \
                            "\xC1\xD3\xC7\xC4\xF0\xF2\xF1\xF0"  
#undef Qc3_Alg_Stream_Cipher
#define Qc3_Alg_Stream_Cipher                                               \
                            "\xC1\xD3\xC7\xC4\xF0\xF3\xF0\xF0"  
#undef Qc3_Alg_Public_Key
#define Qc3_Alg_Public_Key  "\xC1\xD3\xC7\xC4\xF0\xF4\xF0\xF0"  
#undef Qc3_Alg_Hash
#define Qc3_Alg_Hash        "\xC1\xD3\xC7\xC4\xF0\xF5\xF0\xF0"  
#undef Qc3_Data
#define Qc3_Data            "\xC4\xC1\xE3\xC1\xF0\xF1\xF0\xF0"  
#undef Qc3_Array
#define Qc3_Array           "\xC4\xC1\xE3\xC1\xF0\xF2\xF0\xF0"  
#undef Qc3_Key_Token
#define Qc3_Key_Token       "\xD2\xC5\xE8\xC4\xF0\xF1\xF0\xF0"  
#undef Qc3_Key_Parms
#define Qc3_Key_Parms       "\xD2\xC5\xE8\xC4\xF0\xF2\xF0\xF0"  
#undef Qc3_Key_KSLabel
#define Qc3_Key_KSLabel     "\xD2\xC5\xE8\xC4\xF0\xF4\xF0\xF0"  
#undef Qc3_Key_PKCS5
#define Qc3_Key_PKCS5       "\xD2\xC5\xE8\xC4\xF0\xF5\xF0\xF0"  
#undef Qc3_Key_PEMCert
#define Qc3_Key_PEMCert     "\xD2\xC5\xE8\xC4\xF0\xF6\xF0\xF0"  
#undef Qc3_Key_CSLabel
#define Qc3_Key_CSLabel     "\xD2\xC5\xE8\xC4\xF0\xF7\xF0\xF0"  
#undef Qc3_Key_CSDN
#define Qc3_Key_CSDN        "\xD2\xC5\xE8\xC4\xF0\xF8\xF0\xF0"  
#undef Qc3_Key_AppID
#define Qc3_Key_AppID       "\xD2\xC5\xE8\xC4\xF0\xF9\xF0\xF0"  
...
#define Qc3_OFB             '\xF2'      
#undef Qc3_CFB1Bit
#define Qc3_CFB1Bit         '\xF3'      
#undef Qc3_CFB8Bit
#define Qc3_CFB8Bit         '\xF4'      
#undef Qc3_CFB64Bit
#define Qc3_CFB64Bit        '\xF5'      
#undef Qc3_CUSP
#define Qc3_CUSP            '\xF6'      
#undef Qc3_CTR
#define Qc3_CTR             '\xF7'      
...
#define Qc3_CCM             '\xF8'      
#undef Qc3_No_Pad
#define Qc3_No_Pad          '\xF0'      
#undef Qc3_Pad_Char
#define Qc3_Pad_Char        '\xF1'      
#undef Qc3_Pad_Counter
#define Qc3_Pad_Counter     '\xF2'      
#undef Qc3_PKCS1_00
#define Qc3_PKCS1_00        '\xF0'      
#undef Qc3_PKCS1_01
#define Qc3_PKCS1_01        '\xF1'      
#undef Qc3_PKCS1_02
#define Qc3_PKCS1_02        '\xF2'      
#undef Qc3_ISO9796
#define Qc3_ISO9796         '\xF3'      
#undef Qc3_Zero_Pad
#define Qc3_Zero_Pad        '\xF4'      
#undef Qc3_ANSI_X931
#define Qc3_ANSI_X931       '\xF5'      
#undef Qc3_OAEP
#define Qc3_OAEP            '\xF6'      
#undef Qc3_Bin_String
#define Qc3_Bin_String      '\xF0'      
#undef Qc3_BER_String
#define Qc3_BER_String      '\xF1'      
#undef Qc3_MK_Struct
#define Qc3_MK_Struct       '\xF3'      
#undef Qc3_KSLabel_Struct
#define Qc3_KSLabel_Struct  '\xF4'      
#undef Qc3_PKCS5_Struct
#define Qc3_PKCS5_Struct    '\xF5'      
#undef Qc3_PEMCert_String
#define Qc3_PEMCert_String  '\xF6'      
#undef Qc3_CSLabel_String
#define Qc3_CSLabel_String  '\xF7'      
#undef Qc3_CSDN_String
#define Qc3_CSDN_String     '\xF8'      
#undef Qc3_Clear
#define Qc3_Clear           '\xF0'      
#undef Qc3_Encrypted
#define Qc3_Encrypted       '\xF1'      
#undef Qc3_MK_Encrypted
#define Qc3_MK_Encrypted    '\xF2'      
#undef Qc3_Any_CSP
#define Qc3_Any_CSP         '\xF0'      
#undef Qc3_Sfw_CSP
#define Qc3_Sfw_CSP         '\xF1'      
#undef Qc3_Hdw_CSP
#define Qc3_Hdw_CSP         '\xF2'      
#undef Qc3_Continue
#define Qc3_Continue        '\xF0'      
#undef Qc3_Final
#define Qc3_Final           '\xF1'      
#undef Qc3_MK_New
#define Qc3_MK_New          '\xF0'      
#undef Qc3_MK_Current
#define Qc3_MK_Current      '\xF1'      
#undef Qc3_MK_Old
#define Qc3_MK_Old          '\xF2'      
#undef Qc3_MK_Pending
#define Qc3_MK_Pending      '\xF3'      
...
struct _libssh2_os400qc3_crypto_ctx {
    Qc3_Format_ALGD0100_T           hash;           
    Qc3_Format_KEYD0100_T           key;            
    _libssh2_os400qc3_crypto_ctx *  kek;            
};
